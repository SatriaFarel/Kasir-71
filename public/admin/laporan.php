    ...
    <div class="w-4/5 mt-4 flex flex-col">
        ...
        <div class="grid grid-cols-3 gap-4 mt-6 text-center">
            <div class="bg-green-500 text-white rounded-full w-40 h-40 flex flex-col items-center justify-center mx-auto shadow-lg">
                ...
                <p class="text-xl font-bold">Rp <?= number_format($summary['total_keuntungan'], 0, ',', '.'); ?></p>
            </div>
        ...
        <div id="page2" class="bg-slate-300 border p-3 mt-5 hidden">
...
function printTablePDF() {
    window.open('function/printTabel.php?bulan=<?= $bulan; ?>&tahun=<?= $tahun; ?>', '_blank');
}
